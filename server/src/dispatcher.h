#ifndef _PROTOBUF_CODEC_DISPATCHER_H
#define _PROTOBUF_CODEC_DISPATCHER_H
...
class Callback : noncopyable
{
 public:
  ...
  virtual void onMessage(const net::TcpConnectionPtr&,
...
#endif  // _PROTOBUF_CODEC_DISPATCHER_H
